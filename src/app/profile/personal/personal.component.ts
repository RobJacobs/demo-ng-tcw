...
export class PersonalComponent extends BaseFormComponent {
  public formGroup = this.cache.formGroup.get('personalFormGroup') as FormGroup;
  public friends = this.formGroup.get('friends') as FormArray;
  ...
  constructor(public cache: ProfileCacheService, public appDataService: AppDataService) {
    super();
  ...
  public addFriend() {
    this.friends.push(new FormControl(null, { validators: [Validators.required] }));
  }

  public deleteFriend(index: number) {
